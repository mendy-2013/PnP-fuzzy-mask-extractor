...
class Session:
    def __init__(self):
        ...
        self.log_dir = './logdir_res/100H/'
        self.model_dir = './model_res/100H/'
        ...
        self.test_data_path = 'testing/real.txt'  # test dataset txt file path
        self.train_data_path = './dataset/train/100H/100H_mask.txt'  # train dataset txt file path
    ...
    def inf_batch(self, name, batch):
        ...
        for i in range(len(_attention)):
            l_att_a_m += 0.25 * self.l2(B, _attention[i])
